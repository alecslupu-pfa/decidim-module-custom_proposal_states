...
describe Decidim::Proposals::ProposalMentionedEvent do
  ...
  let(:source_proposal) { create :proposal, component: create(:extended_proposal_component, organization: organization), title: "Proposal A" }
  let(:mentioned_proposal) { create :proposal, component: create(:extended_proposal_component, organization: organization), title: "It's proposal B" }
