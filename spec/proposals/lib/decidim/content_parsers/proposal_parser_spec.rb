    ...
    describe ProposalParser do
      ...
      describe "on parse" do
        ...
        context "when content links to an organization different from current" do
          ...
          let(:external_proposal) { create(:extended_proposal, component: create(:extended_proposal_component, organization: create(:organization))) }
          let(:content) do
        ...
        context "when content has many links" do
          let(:proposal1) { create(:extended_proposal, component: component) }
          let(:proposal2) { create(:extended_proposal, component: component) }
          let(:proposal3) { create(:extended_proposal, component: component) }
          let(:content) do
